...
layers configuration. You are free to put any user code."
  ...
  ;; text manipulation
  (define-key evil-motion-state-map "x" 'evil-inner-symbol)
  (define-key evil-motion-state-map "z" 'evil-inner-paren)
...
(defun save-all-and-kill-frame ()
  (interactive)
  (call-interactively* 'evil-write-all 'spacemacs/frame-killer))
